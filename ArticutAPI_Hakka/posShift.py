...
shiftRule =[(re.compile("<ACTION_verb>歸</ACTION_verb><MODIFIER>暗</MODIFIER>"),("MODIFIER",),("TIME_justtime",)),
            ...
            (re.compile("<FUNC_inter>無</FUNC_inter><ENTITY_noun>味緒</ENTITY_noun>"),("FUNC_inter",),("FUNC_negation",)),
            ...
            (re.compile("<FUNC_degreeHead>[恁盡過當蓋異]</FUNC_degreeHead><ACTION_verb>[^<驚想感謝牽成惱敢有到愁中意得惜]+</ACTION_verb>"), ("ACTION_verb",), ("MODIFIER",)),
            ...
            (re.compile("<ACTION_verb>[^<愛擐會]+</ACTION_verb><ACTION_verb>[出來下來入得著落去歸轉開來]+</ACTION_verb>"),("</ACTION_verb><ACTION_verb>",), ("",)),
            ...
            (re.compile("<ACTION_verb>同</ACTION_verb>(?=.*<ACTION_verb>[阿腦討食借講行]+</ACTION_verb>)"), ("ACTION_verb",), ("FUNC_conjunction",)),
            ...
            (re.compile("<ENTITY_noun>[^<選手]+</ENTITY_noun><ENTITY_noun>[油票比賽袋箱仔糖湯課海報桌山風肉毛價值理想方面色絲研究]+</ENTITY_noun>"), ("</ENTITY_noun><ENTITY_noun>",), ("",)),
