...
shiftRule =[(re.compile("<ACTION_verb>歸</ACTION_verb><MODIFIER>暗</MODIFIER>"),("MODIFIER",),("TIME_justtime",)),
            ...
            (re.compile("((?<=</ENTITY_num>)|(?<=</QUANTIFIER>))<ENTITY_noun>[身錢]+</ENTITY_noun>"),("ENTITY_noun",),("ENTITY_classifier",)),
            ...
            (re.compile("<FUNC_inter>無</FUNC_inter>(<FUNC_negation>毋</FUNC_negation>)<ACTION_verb>著</ACTION_verb>"),("FUNC_inter","ACTION_verb",),("FUNC_negation","MODIFIER",)),
            (re.compile("<FUNC_inter>無</FUNC_inter>((?=<ACTION_verb>)|(?=<MODIFIER>)|(?=<MODAL>)|(?=<FUNC_degreeHead>))"),("FUNC_inter",),("FUNC_negation",)),
            (re.compile("<FUNC_inter>無</FUNC_inter><ENTITY_noun>[味緒路錢精神]+</ENTITY_noun>"),("FUNC_inter",),("FUNC_negation",)),
            ...
            (re.compile("<FUNC_inner>還</FUNC_inner><MODIFIER>[^<罅光光本本共樣]+</MODIFIER>"),("<FUNC_inner>", "</FUNC_inner><MODIFIER>", "</MODIFIER>"), ("<DegreeP>", "", "</DegreeP>")),            
            (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_num>[^<]+</ENTITY_num>"), ("</ENTITY_num><ENTITY_num>",), ("",)),
            ...
            (re.compile("<ENTITY_num>五</ENTITY_num><ENTITY_classifier>[個隻]+</ENTITY_classifier><ENTITY_classifier>班</ENTITY_classifier>"),("<ENTITY_classifier>班</ENTITY_classifier>",),("<ENTITY_noun>班</ENTITY_noun>",)),
            (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ACTION_verb>棧</ACTION_verb>"), ("ACTION_verb", ), ("ENTITY_classifier", )),
            ...
            (re.compile("<MODIFIER>半</MODIFIER><ENTITY_classifier>[^<]+</ENTITY_classifier>"), ("</MODIFIER><ENTITY_classifier>", "MODIFIER"), ("", "ENTITY_classifier")),
            ...
            (re.compile("<FUNC_degreeHead>[恁盡過當蓋異]</FUNC_degreeHead><ACTION_verb>[^<驚想感謝牽成惱敢有到愁中意得惜會翕講]+</ACTION_verb>"), ("ACTION_verb",), ("MODIFIER",)),
            ...
            (re.compile("<FUNC_determiner>[^<]+</FUNC_determiner><ENTITY_classifier>半</ENTITY_classifier><ENTITY_classifier>析</ENTITY_classifier>"),("<ENTITY_classifier>半</ENTITY_classifier>",), ("<QUANTIFIER>半</QUANTIFIER>",)),
            ...
            (re.compile("<ACTION_verb>歸</ACTION_verb><MODIFIER>半日</MODIFIER>"),("ACTION_verb","MODIFIER",), ("QUANTIFIER","ENTITY_noun")),
            (re.compile("<ACTION_verb>[^<愛擐會著尞]+</ACTION_verb><ACTION_verb>[出來下來入得著落去歸轉開來死]+</ACTION_verb>"),("</ACTION_verb><ACTION_verb>",), ("",)),
            ...
            (re.compile("<ACTION_verb>同</ACTION_verb>(?=.*<MODIFIER>共樣</MODIFIER>)"), ("ACTION_verb",), ("FUNC_conjunction",)),
            ...
            (re.compile("<MODIFIER>好</MODIFIER><FUNC_inner>比</FUNC_inner>"), ("FUNC_inner",), ("ACTION_verb",)),
            ...
            (re.compile("<ENTITY_noun>[^<選手]+</ENTITY_noun><ENTITY_noun>[錢鞋菜油票比賽袋箱仔糖湯課海報桌山風肉毛價值理想方面色絲研究水人物能力認證考試研究所]+</ENTITY_noun>"), ("</ENTITY_noun><ENTITY_noun>",), ("",)),
            ...
            (re.compile("<TIME_justtime>禮拜日</TIME_justtime><TIME_justtime>日</TIME_justtime>(<ACTION_verb>[^<]+</ACTION_verb>)"), ("<TIME_justtime>禮拜日</TIME_justtime><TIME_justtime>日</TIME_justtime>",), ("<TIME_justtime>禮拜</TIME_justtime><TIME_justtime>日日</TIME_justtime>",)),
            ...
            (re.compile("<DegreeP>[^<]+</DegreeP><ACTION_verb>種</ACTION_verb>"),("ACTION_verb",),("ENTITY_noun",)),
            (re.compile("<ACTION_verb>做</ACTION_verb><CLAUSE_Q>哪</CLAUSE_Q>"),("CLAUSE_Q",),("CLAUSE_particle",)),
            (re.compile("<MODIFIER>第</MODIFIER><ENTITY_num>[^<]+</ENTITY_num>"),("</MODIFIER><ENTITY_num>","ENTITY_num",),("","MODIFIER",)),
            (re.compile("<TIME_justtime>[^<]+</TIME_justtime><ENTITY_oov>鐘</ENTITY_oov>"),("</TIME_justtime><ENTITY_oov>","ENTITY_oov",),("","TIME_justtime",)),
            (re.compile("<ACTION_verb>上</ACTION_verb><ENTITY_classifier>一回</ENTITY_classifier>"),("ACTION_verb",),("MODIFIER",)),
            (re.compile("<ENTITY_DetPhrase>這句</ENTITY_DetPhrase><ACTION_verb>話</ACTION_verb>"),("ACTION_verb",),("ENTITY_noun",)),
            (re.compile("<ENTITY_possessive>厥</ENTITY_possessive><RANGE_locality>面項</RANGE_locality>"),("<RANGE_locality>面項</RANGE_locality>",),("<ENTITY_noun>面</ENTITY_noun><RANGE_locality>項</RANGE_locality>",)),
            (re.compile("(?<=</ACTION_verb>)<ENTITY_num>一</ENTITY_num><ACTION_verb>輪</ACTION_verb>"),("</ENTITY_num><ACTION_verb>","ENTITY_num","ACTION_verb",),("","ACTION_eventQuantifier","ACTION_eventQuantifier",)),
            (re.compile("<ENTITY_num>[^<]+</ENTITY_num><ENTITY_noun>[秒分]</ENTITY_noun>"),("</ENTITY_num><ENTITY_noun>","ENTITY_num","ENTITY_noun"),("","TIME_justtime","TIME_justtime",)),
            (re.compile("<DegreeP>恁大</DegreeP><ENTITY_noun>頭</ENTITY_noun>"),("</DegreeP><ENTITY_noun>","ENTITY_noun",),("","DegreeP",)),
            (re.compile("<LOCATION>中山路</LOCATION><ENTITY_classifier>一段</ENTITY_classifier>"),("</LOCATION><ENTITY_classifier>","ENTITY_classifier",),("","LOCATION",)),
            (re.compile("(<CLAUSE_Q>麼个</CLAUSE_Q>|<FUNC_inner>个</FUNC_inner>)<ACTION_verb>話</ACTION_verb>"),("ACTION_verb",),("ENTITY_noun",)),
            (re.compile("<FUNC_inner>正</FUNC_inner><ACTION_verb>著</ACTION_verb>"),("ACTION_verb",),("MODIFIER",)),
            (re.compile("<FUNC_negation>毋</FUNC_negation><MODIFIER>好在</MODIFIER>"),("<FUNC_negation>毋</FUNC_negation><MODIFIER>好在</MODIFIER>",),("<FUNC_negation>毋好</FUNC_negation><ACTION_verb>在</ACTION_verb>",)),
            (re.compile("<FUNC_inner>還</FUNC_inner>(?=.*<ENTITY_noun>錢</ENTITY_noun>)"),("FUNC_inner",),("ACTION_verb",)),
            (re.compile("<MODIFIER>緊</MODIFIER>(?=<MODIFIER>)"),("MODIFIER",),("FUNC_inner",)),
]